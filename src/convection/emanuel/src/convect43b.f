...
C
     ...
     *     FV,  FTRA, PRECIP, WD,   TPRIME, QPRIME, CBMF  , th )
C
C-----------------------------------------------------------------------------
C    *** On input:      ***
C
...
C
      ...
      REAL LV(ND+1),LVCP(ND+1),LV0,H(ND+1),HP(ND+1),GZ(ND+1),HM(ND+1)
C
c+++climt
c     Physical constants initialised in driver
      common/emanuel_const/Cpd,Cpv,Cl,Rv,Rd,Lv0,g,rowl,elcrit,tlcrit,
     $                     entp,sigd,sigs,omtrain,omtsnow, 
...
C
C   *** ELCRIT IS THE AUTOCONVERSION THRESHOLD WATER CONTENT (gm/gm) ***
...
C-------         DAMP=0.1
C------- C
C------- C   ***        ASSIGN VALUES OF THERMODYNAMIC CONSTANTS,        ***
C------- C   ***            GRAVITY, AND LIQUID WATER DENSITY.           ***
C------- C   ***             THESE SHOULD BE CONSISTENT WITH             ***
C------- C   ***              THOSE USED IN CALLING PROGRAM              ***
C------- C   ***     NOTE: THESE ARE ALSO SPECIFIED IN SUBROUTINE TLIFT  ***
C------- C
C-------       CPD=1005.7
C-------       CPV=1870.0
C-------       CL=2500.0 
