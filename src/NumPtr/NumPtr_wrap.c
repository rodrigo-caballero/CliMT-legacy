...
#define  SWIGTYPE_p_p_p_double swig_types[2] 
...
extern int getstride1(PyObject *);
extern double *getpointer1(PyObject *);
extern double **getpointer2(PyObject *);
extern double ***getpointer3(PyObject *);
extern void test1(double *,int);
extern void test2(double **,int,int);
extern void test3(double ***,int,int,int);
#ifdef __cplusplus
extern "C" {
#endif
static PyObject *_wrap_getstride1(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    PyObject *arg1 = (PyObject *) 0 ;
    int result;
    PyObject * obj0 = 0 ;
    
    if(!PyArg_ParseTuple(args,(char *)"O:getstride1",&obj0)) goto fail;
    arg1 = obj0;
    result = (int)getstride1(arg1);
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"getstride1", _wrap_getstride1, METH_VARARGS },
