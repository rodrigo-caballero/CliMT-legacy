...
C
C CVS: $Id: orb_cosz.h,v 1.1 2004/09/07 15:27:32 rca Exp $
C CVS: $Source: /Users/rca/cvsroot/CliMT/src/radiation/ccm3/src/crm-2.1.2-ccm-3.6/src/csm_share/orb_cosz.h,v $
C CVS: $Name:  $
C
C-----------------------------------------------------------------------
C ------------- Parameters ----------------------------------
